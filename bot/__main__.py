...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("𝐎𝐖𝐍𝐄𝐑", "https://t.me/bruce_3_33")
    buttons.buildbutton("𝐑𝐄𝐏𝐎𝐑𝐓", "https://t.me/+0oXri_0r9PA0OTVl")
...
'''
        ...
        sendMarkup('𝐍𝐨𝐭 𝐀𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫! 𝐃𝐞𝐩𝐥𝐨𝐲 𝐘𝐨𝐮𝐫 𝐎𝐰𝐧 𝐌𝐢𝐫𝐫𝐨𝐫 𝐁𝐨𝐭', context.bot, update.message, reply_markup)
...
def main():
    ...
    if ospath.isfile(".restartmsg"):
        with open(".restartmsg") as f:
            chat_id, msg_id = map(int, f)
        bot.edit_message_text("𝐁𝐎𝐓 𝐑𝐄𝐒𝐓𝐀𝐑𝐓𝐄𝐃 \n\nRe-Mirror Your Things\n\n#Rebooted", chat_id, msg_id)
        osremove(".restartmsg")
